...
export default function LoginPage() {
  ...
  const { login, currentUser } = useProfile();
  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.imagePlaceholder}>
        <Video
          source={require("@/assets/images/login-image.mp4")}
          style={styles.video}
          isLooping
          shouldPlay
          resizeMode="contain"
      ...
      <View style={styles.inputContainer}>
        ...
        <TouchableOpacity onPress={() => router.push('/forget-password/email')}>
        ...
        >
          ...
          <TouchableOpacity onPress={() => router.replace("/signup/page")}>
